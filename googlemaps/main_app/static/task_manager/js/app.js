...
const App = function () {
    ...
    const sidebarMainResize = function() {
        ...
        if (sidebarMainElement) {
            ...
            if (localStorage.getItem('sidebarResized') === 'true') {
                sidebarMainElement.classList.add(resizeClass);
            }

            if (localStorage.getItem('sidebarUnfold') === 'true') {
            ...
            sidebarMainToggler.forEach(function(toggler) {
                toggler.addEventListener('click', function(e) {
                    ...
                    // Переключаем класс для уменьшения сайдбара
                    sidebarMainElement.classList.toggle(resizeClass);

                    // Если сайдбар был уменьшен, убираем unfoldClass, иначе - оставляем
                    if (!sidebarMainElement.classList.contains(resizeClass)) {
                        sidebarMainElement.classList.remove(unfoldClass);
                    }

                    // Сохраняем состояние в localStorage
                    localStorage.setItem('sidebarResized', sidebarMainElement.classList.contains(resizeClass));
                    localStorage.setItem('sidebarUnfold', sidebarMainElement.classList.contains(unfoldClass));
                });
            });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Установка класса active на активную ссылку навигации мой
